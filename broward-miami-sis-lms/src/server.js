...
function examSettingsForLesson(lesson = {}) {
  const title = String(lesson.title || "");
  if (/\[PN104 DAY 2026\] Midterm Exam/i.test(title)) return { label: "PN 104 Day Course Midterm Exam", minutes: 90, opensAt: "2026-08-17T00:00:00-04:00", closesAt: "2026-08-21T23:59:59-04:00" };
