...
const officialTitle = "[PN104 DAY 2026] Official Midterm — Chapters 1–8 and 15–18";
const title = "[PN104 DAY 2026] Midterm — Chapters 1–8 and 15–18";
...
const content = `Canvas item type: Exam.\n\nPRIVATE MIDTERM FOR SAMANTHA BRUNVIL. Complete all 50 original questions covering Chapters 1–8 and 15–18. Select the one best answer. You have 60 minutes after selecting Start Now.\n\nQUIZ_DATA_BASE64:${Buffer.from(JSON.stringify(questions), "utf8").toString("base64")}`;

module.exports = { title, officialTitle, previousTitle, legacyTitle, studentEmail, dueDate, questions, content };
